...
// import {  faFacebook, faLinkedin} from '@fortawesome/free-solid-svg-icons'
        ...
        <div className='footer-container'>
            ...
            <div className='footer-bottom'>
                ...
                <p className='footer-bottom-country'>
                    Quốc gia & Khu vực:
                    <a> Singapore</a> <span className='footer-bottom-line'></span>
                    <a> Indonesia</a> <span className='footer-bottom-line'></span>
                    <a> Đài Loan</a> <span className='footer-bottom-line'></span>
                    <a> Thái Lan</a> <span className='footer-bottom-line'></span>
                    <a> Malaysia</a> <span className='footer-bottom-line'></span>
                    <a> Việt Nam</a> <span className='footer-bottom-line'></span>
                    <a> Philippines</a> <span className='footer-bottom-line'></span>
                    <a> Brazil</a> <span className='footer-bottom-line'></span>
                    <a> México</a> <span className='footer-bottom-line'></span>
                    <a> Colombia</a> <span className='footer-bottom-line'></span>
                    <a> Chile</a> 
                </p>
            </div>
            <div className='footer-list_item'>
                <div className='footer-list-link'>
                    <a>CHÍNH SÁCH BẢO MẬT</a> <span className='footer-bottom-line footer-line'></span>
                </div>
                <div className='footer-list-link'>
                    <a>QUY CHẾ HOẠT ĐỘNG</a> <span className='footer-bottom-line footer-line'></span>
                </div>
                <div className='footer-list-link'>
                    <a>CHÍNH SÁCH VẬN CHUYỂN</a> <span className='footer-bottom-line footer-line'></span>
                </div>
                <div className='footer-list-link'>
